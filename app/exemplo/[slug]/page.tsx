...
// Dados dos exemplos completos
const exampleTimelines: Record<string, TimelineWithMoments> = {
  'romantico': {
    id: '1',
    slug: 'romantico',
...
export default function ExampleTimelinePage({
  params,
}: {
  params: { slug: string }
}) {
  const timeline = exampleTimelines[params.slug]
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <a href="/explore" className="text-pink-600 hover:text-pink-700">
